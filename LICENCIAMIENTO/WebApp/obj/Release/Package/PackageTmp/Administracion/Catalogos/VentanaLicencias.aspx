<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaLicencias.aspx.cs" Inherits="WebApp.Administracion.Catalogos.VentanaLicencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnGuardar">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="chkPeriodo" UpdatePanelHeight="100%"/>
                    <telerik:AjaxUpdatedControl ControlID="chkVolumen" UpdatePanelHeight="100%"/>
    ...
    <div style="clear: both;"></div>
      ...
      <div class="ctrlBasico">
        <div class="divControlIzquierda">
            <asp:Label ID="lblPeriodo" Text="Por periodo" runat="server"></asp:Label>
        </div>
        <div class="divControlDerecha">
            <telerik:RadCheckBox ID="chkPeriodo" runat="server"></telerik:RadCheckBox>
        </div>
    </div>
    <div style="clear: both;"></div>
      ...
      <div class="ctrlBasico">
        <div class="divControlIzquierda">
            <asp:Label ID="lblVolumen" Text="Por volumen" runat="server"></asp:Label>
        </div>
        <div class="divControlDerecha">
            <telerik:RadCheckBox ID="chkVolumen" runat="server"></telerik:RadCheckBox>
        </div>
    </div>
    <div style="clear: both;"></div>
