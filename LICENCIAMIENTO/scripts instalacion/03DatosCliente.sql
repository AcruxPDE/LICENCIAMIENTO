...
SELECT * FROM Nomina.S_CONFIGURACION WHERE CL_CONFIGURACION IN 
('CL_PASS_WS','OBJ_ADICIONAL','FE_CREACION','CL_RAZON_SOCIAL','CL_LICENCIAMIENTO');

DELETE FROM Nomina.S_CONFIGURACION WHERE CL_CONFIGURACION IN 
('CL_PASS_WS','OBJ_ADICIONAL','FE_CREACION','CL_RAZON_SOCIAL','CL_LICENCIAMIENTO');
